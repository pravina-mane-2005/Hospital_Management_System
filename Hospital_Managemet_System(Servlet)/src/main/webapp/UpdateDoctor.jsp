    ...
    <div class="container-fluid">
        <div class="update-container">
            ...
            <form action="updateDoctor" method="post">
                ...
                <label>Status:</label>
                <input type="text" name="dateOfBirth" value="${status}" required>

                <label>Specialization:</label>
                <input type="text" name="address" value="${specialization}" required>

                <label>Contact No:</label>
                <input type="text" name="disease" value="${phone_number}" required>
