...
var spark01 = {
  ...
  colors: ['rgba(255, 183, 72, .5)'],

}
document.getElementById('btc-marketcap').innerHTML = '';
var spark01 = new ApexCharts(document.querySelector("#btc-marketcap"), spark01);
spark01.render();
...
var spark02 = {
  ...
  colors: ['rgba(139, 126, 255, .5)'],

}
document.getElementById('eth-marketcap').innerHTML = '';
var spark02 = new ApexCharts(document.querySelector("#eth-marketcap"), spark02);
spark02.render();
...
var spark03 = {
  ...
  colors: ['rgba(53, 189, 170, .5)'],

}
document.getElementById('iota-marketcap').innerHTML = '';
var spark03 = new ApexCharts(document.querySelector("#iota-marketcap"), spark03);
spark03.render();
...
var spark04 = {
  ...
  colors: ['rgba(46, 142, 247, .5)'],

}
document.getElementById('xrp-marketcap').innerHTML = '';
var spark04 = new ApexCharts(document.querySelector("#xrp-marketcap"), spark04);
spark04.render();
...
var spark05 = {
  ...
  colors: ['rgba(var(--dark-rgb), .5)'],

}
document.getElementById('ltc-marketcap').innerHTML = '';
var spark05 = new ApexCharts(document.querySelector("#ltc-marketcap"), spark05);
spark05.render();
...
document.getElementById('dash-marketcap').innerHTML = '';
var spark06 = new ApexCharts(document.querySelector("#dash-marketcap"), spark06);
spark06.render();
