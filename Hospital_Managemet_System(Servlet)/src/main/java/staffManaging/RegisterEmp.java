    ...
    protected void service(HttpServletRequest req, HttpServletResponse res) 
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement(
                "INSERT INTO hospital.staff_data (full_name,role,department,contact,shift, payement_status, date_of_joining,  ) VALUES ( ?, ?, ?, ?, ?, ?, ?)"
            );
            ...
            if (rowsAffected >= 1) {
                req.setAttribute("Registered", "Employee added successfully!");
            } else {
                req.setAttribute("Unregistered", "Unable to add Employee.");
            }
